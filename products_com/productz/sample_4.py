...
for i in range(1, pages):
    ...
    for j in range(1, 61):
        ...
        try:
            ...
            elif screen_size[0] == slap4:
                wifi_var = screen_size[1]
            else:
                pass
        ...
        try:
            ...
            elif resolution[0] == slap4:
                wifi_var = resolution[1]
            else:
                pass
        except:
            resolution_var = ""
        ...
        try:    
            wifi = driver.find_element(by=By.XPATH, value='//*[@id="products-filters-container"]/div/div[2]/a[{}]/ul/li[4]'.format(str(j)))
            wifi = wifi.text.split(":")
