...
class AppDynamicsJob(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Chrome(executable_path="/home/ritesh/Videos/Jason/Scrapper/chromedriver")
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element_by_xpath("(//input[@type='text'])[2]").send_keys("indore")
